...
export class BookListComponent implements OnInit {
  ...
  //methode wird aufgerufen, wenn komponente initialisiert wird, aber noch nicht fertig gerendert //ist
  ngOnInit() {
    this.books = [
      new Book(
        1,
        ...
        "Angular",
        [
          new Author(1, "Johannes", "Hoppe"),
          new Author(2, "Danny", "Koppenhagen"),
          new Author(3, "Ferdinand", "Malcher"),
          new Author(4, "Gregor", "Woiwode")
        ],
        new Date(2017, 3, 1),
        1,
      ...
      new Book(
        ...
        "AngularJS",
        [
          new Author(5, "Philipp", "Tarasiewicz"),
          new Author(6, "Robin", "Böhm")
        ],
        new Date(2014, 5, 29),
        1,
